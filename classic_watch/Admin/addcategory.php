...
{
	$cn=makeconnection();
	$s="insert into categories_types(Category_Name ) values('" . $_POST["t1"] ."')";
	mysqli_query($cn,$s);
...
<table>
	<tr><td><?php include('left.php'); ?></td>

<td>
	<form method="post" style="margin-right: -1000px;">
<table border="0" width="400px" height="200px" align="center" class="tableshadow" >
<tr><td colspan="2" class="toptd">Add Category</td></tr>
<tr><td class="lefttxt">Category Name</td><td><input type="text" name="t1" required="required" /></td></tr>
