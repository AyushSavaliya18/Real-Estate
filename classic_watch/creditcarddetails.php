...
if (isset($_POST['submit'])) {
  ...
  $cname=$_POST['cname'];
    ...
    $query="INSERT INTO `creditcard` ( `cardnumber`, `cvv`, `expdate`, `cname`) VALUES ( '$cnum', '$cvv', '$expdate', '$cname')";
   if (mysqli_query($con,$query)) {
    	
       echo "<script>alert('Payment Suceesfully')
    			     window.location.assign('Ordersummary.php')</script>";
...

    {
      ...
      header("Location: creditcarddetails.php");	
    }
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">          	
            <h1 class="mb-0 bread"><mark>CREDIT CARD</mark></h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-7 ftco-animate">
						<form action="#" class="billing-form">
							<h3 class="mb-4 billing-heading">Credit Details</h3>
	          	<div class="row align-items-end">
	          		<div class="col-md-8">
	                <div class="form-group">
	                	<label for="firstname">Card Number</label>
	                  <input type="text" class="form-control" placeholder="---- -------- ----" name="cnum" required="required" pattern="[0-9]{12,19}">
	                </div>
	              </div>
	              <div class="col-md-4">
	                <div class="form-group">
                ...
                <div class="col-md-12">
                	<div class="form-group mt-4">
                		...
                		<center> <input type="submit" name="submit" value="Place an Order"  ></center>
            ...
            ?>
	          			...
	          			<p class="d-flex">
		    					...
		    					<p class="d-flex total-price">
		    						<span>Total</span>
		    						<span><input type="text" name="total" value="<?php echo $data['tot']; ?>" required="required"></span>
	          	...
	          	<div class="col-md-12">
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<p><input type="submit" name="placeorder" value="Place an Order"  ></p>
								</div>
	          	</div>
