...
include("conn.php");
  ...
  $query="select * from product_table where Category_id=3"; 
    		...
    		<!-- <div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li><a href="steel_belt_watch.php">Steel Belt Watch</a></li>
    					<li><a href="Premium_Watch.php"><mark>Premium Watch</mark></a></li>
