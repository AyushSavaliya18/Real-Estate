...
$query="select * from product_table where Category_id=2";
$watch_records=mysqli_query($con,$query);
    		...
    		<!-- <div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li><a href="smart_watch_list.php">Smart Watch</a></li>
    					<li><a href="steel_belt_watch.php"><mark>Steel Belt Watch</mark></a></li>
    					<li><a href="Premium_Watch.php">Premium Watch</a></li>
    					<li><a href="Leather_Watch.php">Leather Watch</a></li>
    				</ul>
    			</div>
    		</div> -->
    		<div class="row">
          <?php
          // print_r($watch_records);
          while($data=mysqli_fetch_array($watch_records))
          {
          ?>
    			<div class="col-md-6 col-lg-3 ftco-animate">
            <div class="product">
              <a href="viewproduct.php?id=<?php echo $data[0]; ?>"class="img-prod">
                <img class="img-fluid" src="images/<?php echo $data[3]; ?>" alt="Colorlib Template">
                <div class="overlay"></div>
              </a>
              <div class="text py-3 pb-4 px-3 text-center">
                <h3><a href="viewproduct.php"><?php echo $data[1]; ?></a></h3>
                <div class="d-flex">
                  <div class="pricing">
                    <p class="price"><span class="price-sale"><?php echo "₹".$data[4]; ?></span></p>
                  </div>
                </div>
                <div class="bottom-area d-flex px-3">
                  <div class="m-auto d-flex">
                    <a href="viewproduct.php" class="add-to-cart d-flex justify-content-center align-items-center text-center">
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	             <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 98989 24242</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@classicwatch.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
