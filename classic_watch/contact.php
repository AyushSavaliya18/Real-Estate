      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread"><mark>Contact us</mark></h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Address:</span>203 Krishna Complex, Sriji Main Road, Surat-360007</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="tel://+919898924242">+91 98989 24242</a></p>
              <p><span>Phone:</span> <a href="tel://+919724137340">+91 9724137340</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:info@yoursite.com">info@classicwatch.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Website:</span> <a href="#">classicwatch.com</a></p>
	          </div>
          </div>
        </div>
          ...
          <div class="col-md-6 order-md-last d-flex">
            <form method="post" class="bg-white p-5 contact-form">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="msg"   cols="30" rows="7 required="required" placeholder="Message">
              </div>
              <div class="form-group">
