...
{
	$cn=makeconnection();
	$s="delete from CATEGORIES_TYPES  where Category_id='" . $_POST["t1"] . "'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<td><form method="post">
<table   style="margin-right: -700px;"   border="0" width="400px" height="200px" align="center" class="tableshadow">
