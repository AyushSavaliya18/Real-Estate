      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread"><mark>Order Summery</mark></h1>
          </div>
        </div>
      </div>
    </div>
...
<tr>
<td style="font-size:15px; padding:5px; font-weight:bold;">Orderid</td>  
...
?>
              ...
              echo"<center><img src='images/orderconformation.jpg'></center>";   # code...
              }
