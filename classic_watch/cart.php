...
if (isset($_POST['addcart'])) {
	...
	while($data_new=mysqli_fetch_assoc($results))
  {
	...
	if($data_new['Quantity'] >= $_POST['quantity']){
	  ...
	  $to=$pprice*$quantity;
	    $query="INSERT INTO cart(uid, pid, qty, pri, tot) VALUES 
	                            ('$uid','$pid','$quantity','$pprice','$to')";
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread"><mark>My Cart</mark></h1>
          </div>
        </div>
      </div>
    </div>
...
<table border="1" width="90%" height="300px" align="center" class="tableshadow">
...
<td style="font-size:15px; padding:5px; font-weight:bold;">Cart_quantity</td>
...
while($data=mysqli_fetch_assoc($result))
{
    ...
    $d= $data['cid'];
		echo "<form method='POST'><tr><td style=' padding:5px;'><a href='delete.php?id=$d'>Remove</a> </td>
		<td style=' padding:5px;'><IMG src='images/".$data['image']."' style='height:50PX' /></td>
		<td style=' padding:5px;'>".$data['pid']."</td>
...
?>
        ...
        <?php
        // echo  "<p style=' padding:5px;'><a href='checkout.php?id=$d'>Checkout</a> </p>";
        echo "<center>";
        echo "
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">203 Krishna Complex, Sriji Main Road, Rajkot-360007</span></li>
